...
const roadmapSections: { title: string; items: RoadmapItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Alertas de presupuesto", description: "Avisos cuando una categoría se acerca o supera su límite mensual.", icon: "bell" },
      ...
      { title: "Presupuestos (Fijo y Variable)", description: "Presupuestos por categoría con período fijo o variable (mensual), seguimiento y alertas.", status: "available", icon: "wallet" },
